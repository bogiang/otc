<?php
require_once(dirname(__FILE__).'/EtherscanAPIConf.php');
...
class Etherscan {
	...
	public function ercList($contractaddress, $address, $sort = "asc", $page = null, $offset = null) {
        $params = [
            'module' => "account",
            'action' => "tokentx",
	...
	public function ercAllList($startBlock, $address, $sort = "asc") {
        $params = [
            'module' => "account",
            'action' => "tokentx",
            'address' => $address,
